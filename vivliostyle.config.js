module.exports = {
  title: 'kght6123-book-template', // populated into `publication.json`, default to `title` of the first entry or `name` in `package.json`.
  author: 'kght6123 <i.feeling.song+github@gmail.com>', // default to `author` in `package.json` or undefined.
